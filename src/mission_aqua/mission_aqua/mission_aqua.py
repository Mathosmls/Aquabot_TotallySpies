...
#------------------------------------------------------------------------------------------------
# ROS NODE, used to handle the wt watching mission
#------------------------------------------------------------------------------------------------
class MissionAqua(Node):
    def __init__(self):
        ...
        self.id_wt2fix =-1
        self.have_wt=False
        self.last_qr_pos=np.array([0.,0.,0]) #to update the qr_code_pose = pos for phase 3
        self.last_qr_id=-1
...
#------------------------------------------------------------------------------------------------
    ...
    #------------------------------------------------------------------------------------------------
    #callback to update the current pose and handle the different state of the mission
    #------------------------------------------------------------------------------------------------
    def odom_callback(self, msg):
        ...
        if self.current_mode==1 and is_within_distance(self.current_pos,self.current_goal,2.0) and self.phase==1:
        ...
        if self.phase ==2 and is_within_distance(self.current_pos,self.current_goal,0.1):
            ...
            elif (self.get_clock().now()-self.start_phase3)>Duration(seconds=60) :
